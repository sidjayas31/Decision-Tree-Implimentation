...
#Method used traverse the tree for each data point and assign a prediction based
#on our tree. Returns a class label based on our prediction
...
#Returns a decision tree with the depth mentioned
...
if depth == 0:
    print "Majority Class for Depth 0"
